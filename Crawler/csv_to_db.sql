...
-csv 파일 db로 저장
.mode csv
.import ../csv/hapjeong_pub_after.csv hapjeong
.import ../csv/hongdae_pub_after.csv hongdae
.import ../csv/mangwon_pub_after.csv mangwon
.import ../csv/sinchon_pub_after.csv sinchon
.import ../csv/yeoksamdong_pub_after.csv yeoksamdong
.import ../csv/yeonhuidong_pub_after.csv yeonhuidong
.import ../csv/yeonnamdong_pub_after.csv yeonnamdong
--------------------------------------------------------
- id를 가진 table2 생성
